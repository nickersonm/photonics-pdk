...
def die(dieName=dieName):
    ...
    with nazca.Cell(instantiate=True, name=dieName) as die:
        ...
        marks.fCommon.putCorners(marks.utility.ConcentricTLM(xs_pad=['MetalTop', 'MetalVia'], 
                                                            ...
                                                            grow_background=10), 
                                diesize=dieSize, inset=[1250, 0], quadrants=[3])
        ...
        marks.fCommon.putCorners(marks.utility.ConcentricTLM(xs_pad=['MetalTop', 'MetalVia'], 
                                                            grow_pad=[2, 0]), 
                                diesize=dieSize, inset=[1500, 5], quadrants=[3])
        marks.utility.putCorners(marks.utility.CircularTLM(xs_pad=['MetalTop', 'MetalVia'], 
                                                        grow_pad=[1, 0], buffer=40, 
                                                        r0=[14], ratio=[1, 1.5, 2.0],
                                                        ratio_outer=1.5), 
        ...
        dieLabel(dieName).put(800, dieSize[1][1] - 5)
        ...
        PDK.icCleave.strt(length=dieSize[1][0] + 2*wgOverlap, arrow=False).put(-wgOverlap, 2515 - wgOverlap/2)
        y += wgSpace
